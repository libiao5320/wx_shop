...
public class QradeOne {  
     ...
     * @param width 宽
     * @param height 高
     * @param srcImagePath 中心图片
     * @param fileName 二维码名称
     * @return
     * @throws IOException 
     */
    public static String encode(String content, int width, int height,  
            String srcImagePath,String fileName) throws IOException { 
    	String randomStr =fileName+".jpg"; 
    	//当无文件夹的时候创建文件夹
    	String destImagePath = CConfig.imgTicketHost+"/"+fileName+".jpg";
