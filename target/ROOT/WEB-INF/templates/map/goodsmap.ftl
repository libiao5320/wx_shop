...
<article>
    <section class="maps">
        ...
        <div class="maps_d1">
            <h1 class="maps_h1">${store.storeName !''}<span id="distance"></span></h1>
...
$(function(){
	...
	var point = new BMap.Point(${store.lbsX !'0'},${store.lbsY !'0'});
	...
	var pointA = new BMap.Point(${store.lbsX !'0'},${store.lbsY !'0'});  // 创建点坐标A
	var pointB = new BMap.Point(${lbsX !'0'},${lbsY !'0'});  // 创建点坐标B
	
	var distance =  (map.getDistance(pointA,pointB)/1000).toFixed(2)+'km';  //获取两点距离,保留小数点后两位
